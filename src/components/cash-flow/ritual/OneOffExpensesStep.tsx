      ...
      <div className="flex flex-col gap-3 p-7">
        ...
        <div className="flex flex-col gap-2">
          {expenses.map((exp) => (
            <div key={exp.id}>
              {/* Item row */}
              <div className="flex items-center gap-3 rounded-t-[10px] border-[1.5px] border-b-0 border-[#e8e8e5] bg-white px-4 py-3 transition-colors hover:border-[#c5e49a]">
                <button
                  type="button"
                ...
                <button
                  ...
                  className="flex h-6 w-6 flex-shrink-0 items-center justify-center rounded-md border border-[#e8e8e5] text-[11px] text-[#a0aab4] transition-colors hover:border-[#ef4444] hover:bg-[#fef2f2] hover:text-[#ef4444]"
              ...
              {/* Make recurring row */}
              <div className="flex items-center gap-2.5 rounded-b-[10px] border-[1.5px] border-[#fde68a] bg-[#fffbeb] px-3.5 py-2.5">
        ...
        {/* Add form */}
        {showAddForm ? (
          <div className="flex flex-col gap-2 rounded-[10px] border-[1.5px] border-[#e8e8e5] bg-white p-4">
            <input
              type="text"
              value={newDesc}
              onChange={(e) => setNewDesc(e.target.value)}
              placeholder="Description"
              className="rounded-lg border-[1.5px] border-[#e8e8e5] px-3 py-2 text-[13px] font-semibold text-[#1a1a1a] outline-none placeholder:text-[#a0aab4] focus:border-[#8BC34A]"
              autoFocus
            />
            <div className="flex items-center gap-2">
              <div className="flex flex-1 items-center overflow-hidden rounded-lg border-[1.5px] border-[#e8e8e5] focus-within:border-[#8BC34A]">
                <div className="border-r-[1.5px] border-[#e8e8e5] bg-[#f2f1ef] px-2 py-2 font-mono text-xs font-bold text-[#6b7280]">
                  $
                </div>
                <input
                  type="text"
                  ...
                  placeholder="0"
                  className="w-full border-none bg-transparent px-2 py-2 font-mono text-[13px] font-semibold text-[#1a1a1a] outline-none placeholder:text-[#a0aab4]"
                />
              </div>
              <button
                type="button"
                onClick={handleAdd}
                className="rounded-lg bg-[#8BC34A] px-4 py-2 text-xs font-bold text-white hover:bg-[#6a9e32]"
              >
                Add
              </button>
              <button
                ...
                className="rounded-lg border-[1.5px] border-[#e8e8e5] px-3 py-2 text-xs font-semibold text-[#6b7280] hover:bg-[#f7f6f3]"
              >
                Cancel
              </button>
            </div>
          ...
          <button
            ...
            className="flex w-full items-center gap-2 rounded-[10px] border-[1.5px] border-dashed border-[#e8e8e5] bg-transparent px-4 py-3 text-[13px] font-semibold text-[#6b7280] transition-all hover:border-[#8BC34A] hover:bg-[#f1f8e9] hover:text-[#3d6b14]"
          >
        ...
        <div className="flex items-center justify-between rounded-[12px] border-[2px] border-[#fecaca] bg-[#fef2f2] px-5 py-4">
          <div className="text-[13px] font-extrabold text-[#1a1a1a]">Total One-Off Expenses</div>
