    ...
    <>
      ...
      <div className="flex flex-col gap-4 p-7">
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <div className="mt-1 flex items-center overflow-hidden rounded-[10px] border-[1.5px] border-[#e8e8e5] bg-white transition-all focus-within:border-[#8BC34A] focus-within:shadow-[0_0_0_3px_rgba(139,195,74,0.12)]">
            <div className="flex items-center self-stretch border-r-[1.5px] border-[#e8e8e5] bg-[#f2f1ef] px-3 font-mono text-sm font-bold text-[#6b7280]">
              $
            </div>
            <input
              type="text"
              className="flex-1 border-none bg-transparent px-4 py-3.5 font-mono text-[22px] font-medium text-[#1a1a1a] outline-none placeholder:text-[#a0aab4]"
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <div className="mt-1 flex items-center overflow-hidden rounded-[10px] border-[1.5px] border-[#e8e8e5] bg-white transition-all focus-within:border-[#8BC34A] focus-within:shadow-[0_0_0_3px_rgba(139,195,74,0.12)]">
            ...
            <input
              type="text"
              className="flex-1 border-none bg-transparent px-3.5 py-3 font-mono text-[15px] font-medium text-[#1a1a1a] outline-none placeholder:text-[#a0aab4]"
        ...
        <div className="flex items-center justify-between rounded-[12px] border-[2px] border-[#c5e49a] bg-[#f1f8e9] px-5 py-4">
          <div>
            <div className="text-[13px] font-extrabold text-[#3d6b14]">Net Cash Position</div>
